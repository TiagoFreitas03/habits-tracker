			...
			<Dialog.Root>
				<div className='flex flex-col gap-4'>
					...
					<button
						type='button'
						onClick={signOut}
						className='w-full border border-violet-500 font-semibold rounded-lg px-6 py-4 flex justify-center items-center gap-3 hover:border-violet-300 transition-colors focus:outline-none focus:ring-2 focus:ring-violet-700 focus:ring-offset-2 focus:ring-offset-background'
					>
